...
{
    IDLE, CLOSED,  WAIT_ACK_HANDSHAKE, WAIT_SYNACK_HANDSHAKE, RECEPTION_SYNACK_HANDSHAKE, RECEPTION_ACK_DATA, RECEPTION_FINACK_HANDSHAKE, ESTABLISHED, WAIT_ACK_DATA
} protocol_state;
