...
{
    IDLE, WAIT_SYNACK_HANDSHAKE, WAIT_ACK_HANDSHAKE, RECEPTION_SYNACK_HANDSHAKE, ESTABLISHED, WAIT_ACK_DATA, RECEPTION_ACK_DATA, RECEPTION_FINACK_HANDSHAKE, CLOSING, CLOSED
} protocol_state;
